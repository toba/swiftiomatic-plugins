...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "SmBinary",
            url: "https://github.com/toba/swiftiomatic/releases/download/v3.14.11/sm.artifactbundle.zip",
            checksum: "4b6bfca76f2390330642a6edd150eacf4cbf76335b1aa7a88c0f5deb424b8edb"
        ),
        .plugin(
