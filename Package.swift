...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "SmBinary",
            url: "https://github.com/toba/swiftiomatic/releases/download/v3.16.1/sm.artifactbundle.zip",
            checksum: "41e5c56259cb0481ef6e5d529beae8bed9824fb13c0bd5bec398ee25cb087bf6"
        ),
        .plugin(
