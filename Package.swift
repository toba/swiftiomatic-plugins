...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "SmBinary",
            url: "https://github.com/toba/swiftiomatic/releases/download/v3.9.1/sm.artifactbundle.zip",
            checksum: "1731fd317faf858d9d8aab3b3ac063b0724ba9cacd6deb3ab43f0b17517efa72"
        ),
        .plugin(
