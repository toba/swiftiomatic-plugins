...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "SmBinary",
            url: "https://github.com/toba/swiftiomatic/releases/download/4.3.2/sm.artifactbundle.zip",
            checksum: "4923f7faea44219dd7d16bb7431ad4c0e4a6e7da6712f63cce837382ed46a102"
        ),
        .plugin(
