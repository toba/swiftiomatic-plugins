...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "SmBinary",
            url: "https://github.com/toba/swiftiomatic/releases/download/v3.13.0/sm.artifactbundle.zip",
            checksum: "31d85222d614346f0a17332d30d88aef6f4ae28800633b37bf95f299fe64a088"
        ),
        .plugin(
