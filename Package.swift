...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "SmBinary",
            url: "https://github.com/toba/swiftiomatic/releases/download/3.17.2/sm.artifactbundle.zip",
            checksum: "00b74eee300271fd83f4a8ede8b3bf28b1849b0913faac1a9cd94ecea6b3bfc3"
        ),
        .plugin(
