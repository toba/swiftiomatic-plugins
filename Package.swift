...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "SmBinary",
            url: "https://github.com/toba/swiftiomatic/releases/download/v3.5.1/sm.artifactbundle.zip",
            checksum: "23e27f6e5ee5b9158a96a0c155ea972206beda578eab16cf667715f96d929d25"
        ),
        .plugin(
