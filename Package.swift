...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "SmBinary",
            url: "https://github.com/toba/swiftiomatic/releases/download/v3.14.6/sm.artifactbundle.zip",
            checksum: "61cc412c156d0dac6ef3d2330d79b1bf5785f613e41fc60dec8c30927b2785b8"
        ),
        .plugin(
