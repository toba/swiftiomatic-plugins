...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "SmBinary",
            url: "https://github.com/toba/swiftiomatic/releases/download/v3.5.2/sm.artifactbundle.zip",
            checksum: "e20cb217c8bc3857791b28cf68b6e78617937bf793a5ee395b7ed08d1d3c1722"
        ),
        .plugin(
