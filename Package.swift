...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "SmBinary",
            url: "https://github.com/toba/swiftiomatic/releases/download/v3.8.5/sm.artifactbundle.zip",
            checksum: "e4e86487772cdd8e86bf1e6efc4259cb887295def596b46b72ababb8ba6e71e0"
        ),
        .plugin(
