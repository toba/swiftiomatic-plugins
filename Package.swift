...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "SmBinary",
            url: "https://github.com/toba/swiftiomatic/releases/download/4.3.4/sm.artifactbundle.zip",
            checksum: "082302134b68d0156bdaca7ee0eac7b19bc430f1400a9809a7fe3ae77b1df1ea"
        ),
        .plugin(
