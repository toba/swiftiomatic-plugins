...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "SmBinary",
            url: "https://github.com/toba/swiftiomatic/releases/download/v3.14.9/sm.artifactbundle.zip",
            checksum: "55257e68f91207c4e1dc58c4af16d614597c87bf8db4190b93e872db21b49043"
        ),
        .plugin(
