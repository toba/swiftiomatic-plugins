...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "SmBinary",
            url: "https://github.com/toba/swiftiomatic/releases/download/v3.5.3/sm.artifactbundle.zip",
            checksum: "690c5d6b0bffdd92e58443fce646a6b70882cb202e333f98f8676611e7464f73"
        ),
        .plugin(
