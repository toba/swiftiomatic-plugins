...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "SmBinary",
            url: "https://github.com/toba/swiftiomatic/releases/download/v1.0/sm.artifactbundle.zip",
            checksum: "74c09f7becc96de64160cccba35f3d424e0547ef6c8053337c811ba37a19336c"
        ),
        .plugin(
