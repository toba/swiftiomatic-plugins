...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "SmBinary",
            url: "https://github.com/toba/swiftiomatic/releases/download/v3.14.2/sm.artifactbundle.zip",
            checksum: "8386ca52b55eb7fe5217c6c08e58bf0ac73e482b6b832cb25e7f31841fa86160"
        ),
        .plugin(
