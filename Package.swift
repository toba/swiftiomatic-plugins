...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "SmBinary",
            url: "https://github.com/toba/swiftiomatic/releases/download/v3.13.3/sm.artifactbundle.zip",
            checksum: "2b7eed03c5197f6b88e3275d231312375805a266cd79c6194c33188d6702061f"
        ),
        .plugin(
