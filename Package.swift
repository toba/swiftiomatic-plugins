...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "SmBinary",
            url: "https://github.com/toba/swiftiomatic/releases/download/v3.14.3/sm.artifactbundle.zip",
            checksum: "2d7468bc49858c3aaf2f8160931ab335d0a84f8a7cf4ac8d55f88058eb9c302d"
        ),
        .plugin(
