...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "SmBinary",
            url: "https://github.com/toba/swiftiomatic/releases/download/v0.37.0/sm.artifactbundle.zip",
            checksum: "16770570083531540651049fe4ac40584faed219abd8329e47d877593aa83e29"
        ),
        .plugin(
