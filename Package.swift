...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "SmBinary",
            url: "https://github.com/toba/swiftiomatic/releases/download/v3.5.6/sm.artifactbundle.zip",
            checksum: "66d48273314f0ed9f36e4b148e433265f9f80325221133bd2dedd4aa652aabdd"
        ),
        .plugin(
