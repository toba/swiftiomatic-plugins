...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "SmBinary",
            url: "https://github.com/toba/swiftiomatic/releases/download/v0.33.0/sm.artifactbundle.zip",
            checksum: "f6c8bba1e4eecc55042899587b41a2b720e34afafbefb6c2ad599ed68ee0529c"
        ),
        .plugin(
