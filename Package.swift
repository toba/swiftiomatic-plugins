...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "SmBinary",
            url: "https://github.com/toba/swiftiomatic/releases/download/v3.14.5/sm.artifactbundle.zip",
            checksum: "d603390bcc442abe6f0072b194ddd12c0ac9f27de360ba31ca39fa8f75617c24"
        ),
        .plugin(
