...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "SmBinary",
            url: "https://github.com/toba/swiftiomatic/releases/download/v1.4.1/sm.artifactbundle.zip",
            checksum: "2b079593b43a2fae1fc870cb81043d316f0136d6a7a84c73b5c535a07d2b49fe"
        ),
        .plugin(
