...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "SmBinary",
            url: "https://github.com/toba/swiftiomatic/releases/download/v1.3.6/sm.artifactbundle.zip",
            checksum: "2171011cf34b126ea3c25d5897f4f76a08862ed564aca8adbb8affbc4d615155"
        ),
        .plugin(
