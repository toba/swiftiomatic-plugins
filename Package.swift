...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "SmBinary",
            url: "https://github.com/toba/swiftiomatic/releases/download/v3.9.4/sm.artifactbundle.zip",
            checksum: "7438355f9aecca112957067c94ab603c9f11bd2ae999d747663e257c4ce3761b"
        ),
        .plugin(
