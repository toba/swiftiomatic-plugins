...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "SmBinary",
            url: "https://github.com/toba/swiftiomatic/releases/download/v3.12.0/sm.artifactbundle.zip",
            checksum: "f7be45c5b9e29aaafc69d57a5dee23eea42af898e753a47ce4dc4f78679769fb"
        ),
        .plugin(
