...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "SmBinary",
            url: "https://github.com/toba/swiftiomatic/releases/download/4.4.1/sm.artifactbundle.zip",
            checksum: "5e402f36a57a682ab3397fb996659ab9d053cceb8171daefcddc88c722ff6b12"
        ),
        .plugin(
