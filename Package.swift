...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "SmBinary",
            url: "https://github.com/toba/swiftiomatic/releases/download/v3.8.4/sm.artifactbundle.zip",
            checksum: "df64f5e9e1b65b56ad370ca6b9aefad59b4b4d880e386ca3a31a4ea18879189f"
        ),
        .plugin(
