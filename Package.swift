...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "SmBinary",
            url: "https://github.com/toba/swiftiomatic/releases/download/v3.10.1/sm.artifactbundle.zip",
            checksum: "a6f08aaa7a1cb58628e106968febaa6a7e9c8b556d21d09d7f414ba7b795ffcb"
        ),
        .plugin(
