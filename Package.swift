...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "SmBinary",
            url: "https://github.com/toba/swiftiomatic/releases/download/v3.5.8/sm.artifactbundle.zip",
            checksum: "694270521f84702650a9ac01983ca957faa23f0578df43216fd382476503a3fe"
        ),
        .plugin(
