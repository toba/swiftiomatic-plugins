...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "SmBinary",
            url: "https://github.com/toba/swiftiomatic/releases/download/v3.1.4/sm.artifactbundle.zip",
            checksum: "1a2afc1dd6320f5d587a5c2dcb2ceed58e01857642a8d84d6021a42fa9d57efc"
        ),
        .plugin(
