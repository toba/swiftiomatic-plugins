...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "SmBinary",
            url: "https://github.com/toba/swiftiomatic/releases/download/v3.1.6/sm.artifactbundle.zip",
            checksum: "94f741fe7b5a1649e117348e2b467cf78ed4dd74460e25efd9e5b8152b7bc3e9"
        ),
        .plugin(
