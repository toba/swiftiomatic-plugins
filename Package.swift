...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "SmBinary",
            url: "https://github.com/toba/swiftiomatic/releases/download/v0.36.0/sm.artifactbundle.zip",
            checksum: "e76f358f8e8918a5f1b5402e4e26fdb1c67501c1e29b744219e948d0d754f028"
        ),
        .plugin(
