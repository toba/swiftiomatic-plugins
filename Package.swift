...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "SmBinary",
            url: "https://github.com/toba/swiftiomatic/releases/download/v2.0.0/sm.artifactbundle.zip",
            checksum: "1ea317f020c278b58c41b392474636d707e5d55f23aff80cc78e864b09d3e529"
        ),
        .plugin(
