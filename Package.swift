...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "SmBinary",
            url: "https://github.com/toba/swiftiomatic/releases/download/v3.11.0/sm.artifactbundle.zip",
            checksum: "0272b616a4f8ae3be4f8435cdd62e63a54967cd69b2f633c5edb6a7605dd562c"
        ),
        .plugin(
