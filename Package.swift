...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "SmBinary",
            url: "https://github.com/toba/swiftiomatic/releases/download/4.2.0/sm.artifactbundle.zip",
            checksum: "4588e22485532818696dcf2d17e94dbdb02f1ceb4e2e28afcc7d92f034c2af6e"
        ),
        .plugin(
