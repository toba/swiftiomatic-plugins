...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "SmBinary",
            url: "https://github.com/toba/swiftiomatic/releases/download/v3.14.0/sm.artifactbundle.zip",
            checksum: "9e20a33186e93873ef4110419dbcb03d7badd8f884f807d888138bf81425bfcd"
        ),
        .plugin(
