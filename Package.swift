...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "SmBinary",
            url: "https://github.com/toba/swiftiomatic/releases/download/v1.6.0/sm.artifactbundle.zip",
            checksum: "7494abf9481b6d577dec94e8c66aed1d863f63c06081482e5c70669ca0984942"
        ),
        .plugin(
