...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "SmBinary",
            url: "https://github.com/toba/swiftiomatic/releases/download/v3.14.1/sm.artifactbundle.zip",
            checksum: "0b98f30616a6bbf8f145199379517bffcd6452958e8112bd246d13d414f1a73c"
        ),
        .plugin(
