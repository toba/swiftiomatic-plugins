...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "SmBinary",
            url: "https://github.com/toba/swiftiomatic/releases/download/v3.13.2/sm.artifactbundle.zip",
            checksum: "eae5d51416b6af1fbf250011899f863610ce10278bd16826ca96122464d7b64c"
        ),
        .plugin(
