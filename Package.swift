...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "SmBinary",
            url: "https://github.com/toba/swiftiomatic/releases/download/v3.6.0/sm.artifactbundle.zip",
            checksum: "901b567d9efb7fd79f315bb60d39d4a59ce7d791163aa64cf71711f0d0f81a55"
        ),
        .plugin(
