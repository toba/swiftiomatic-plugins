...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "SmBinary",
            url: "https://github.com/toba/swiftiomatic/releases/download/v3.9.0/sm.artifactbundle.zip",
            checksum: "29843b0ce6739e10793ac56e8049163b87056b02d8fef52d3a8464aa10ce7c7c"
        ),
        .plugin(
