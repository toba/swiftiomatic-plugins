...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "SmBinary",
            url: "https://github.com/toba/swiftiomatic/releases/download/v3.16.2/sm.artifactbundle.zip",
            checksum: "4cf5304b4979dc4ebdc32559dc71b86adc600521421b98534db0530635540e7d"
        ),
        .plugin(
