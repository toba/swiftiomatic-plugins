...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "SmBinary",
            url: "https://github.com/toba/swiftiomatic/releases/download/v3.0.3/sm.artifactbundle.zip",
            checksum: "7156322f4a45787de22ffd0efa21acdfe41d5491adebb98af22dd94c35aeb584"
        ),
        .plugin(
