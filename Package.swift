...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "SmBinary",
            url: "https://github.com/toba/swiftiomatic/releases/download/v3.1.2/sm.artifactbundle.zip",
            checksum: "8c4e458e7726e180494eb82eea2a7e787044c11337ffe4501810e998181a71cc"
        ),
        .plugin(
