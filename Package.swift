...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "SmBinary",
            url: "https://github.com/toba/swiftiomatic/releases/download/v3.0.4/sm.artifactbundle.zip",
            checksum: "f249a8fcedd10fc9652dcbc7908cc39800ffe18cbbfab286819774f1b0125ec0"
        ),
        .plugin(
