...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "SmBinary",
            url: "https://github.com/toba/swiftiomatic/releases/download/v1.2.1/sm.artifactbundle.zip",
            checksum: "7ad803bbdeab5372274a79646a158692f6fdb878fb19040dbee4a97fc4824294"
        ),
        .plugin(
