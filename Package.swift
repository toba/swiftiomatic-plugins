...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "SmBinary",
            url: "https://github.com/toba/swiftiomatic/releases/download/v1.0.1/sm.artifactbundle.zip",
            checksum: "dc9a36225cd58ae294ae3239f670d7146c27b1b8211a9819bf86b373c8bbefae"
        ),
        .plugin(
