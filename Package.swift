...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "SmBinary",
            url: "https://github.com/toba/swiftiomatic/releases/download/v3.5.0/sm.artifactbundle.zip",
            checksum: "aba900c6e112ec8d26ea8f0dffd7ac3667b9bf88037832cb5bee3d740ef18392"
        ),
        .plugin(
