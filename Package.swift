...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "SmBinary",
            url: "https://github.com/toba/swiftiomatic/releases/download/v3.14.10/sm.artifactbundle.zip",
            checksum: "5af4ef64c7a075f73a82c1630706bc0e62802c554bc593ab43e061d32d05b234"
        ),
        .plugin(
