...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "SmBinary",
            url: "https://github.com/toba/swiftiomatic/releases/download/v3.14.7/sm.artifactbundle.zip",
            checksum: "c624aeaea4e459c54d44b193fe0b559625bb918b833ec273202421c6bd494a27"
        ),
        .plugin(
