...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "SmBinary",
            url: "https://github.com/toba/swiftiomatic/releases/download/4.3.3/sm.artifactbundle.zip",
            checksum: "df16acb3ca0680fbd8837c60a90ba1ab1a21e97c9cb21d79951154bd8fff3383"
        ),
        .plugin(
