...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "SmBinary",
            url: "https://github.com/toba/swiftiomatic/releases/download/4.4.0/sm.artifactbundle.zip",
            checksum: "d2038d3ad7181a66fc6aa9890405d3d9f53421ba09afadc9eabb46f189152321"
        ),
        .plugin(
