...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "SmBinary",
            url: "https://github.com/toba/swiftiomatic/releases/download/v3.13.4/sm.artifactbundle.zip",
            checksum: "435095e75b52d16cd568f4b6138b3eaeada9f5ddc52ce390335bae780b878868"
        ),
        .plugin(
