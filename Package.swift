...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "SmBinary",
            url: "https://github.com/toba/swiftiomatic/releases/download/v3.14.14/sm.artifactbundle.zip",
            checksum: "d6feefa50c73bbe70b50d91a20f905584762f94078400527d061139c29c30ecc"
        ),
        .plugin(
