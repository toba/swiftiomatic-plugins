...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "SmBinary",
            url: "https://github.com/toba/swiftiomatic/releases/download/v3.4.0/sm.artifactbundle.zip",
            checksum: "b2e16c570e4321bfbeaaaf7cff6136e8eeb163ff90c989645437c7d6a6acc679"
        ),
        .plugin(
