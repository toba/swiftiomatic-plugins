...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "SmBinary",
            url: "https://github.com/toba/swiftiomatic/releases/download/v1.3.1/sm.artifactbundle.zip",
            checksum: "2a9bf3f1096a2ae1bffe8016b1931f2084d34e860cdc50d3b91300443a892b1f"
        ),
        .plugin(
