...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "SmBinary",
            url: "https://github.com/toba/swiftiomatic/releases/download/v3.9.3/sm.artifactbundle.zip",
            checksum: "7885b0ab226fb67d45c129939526edb84a3f129466a4f9b812ad8ff52bab3623"
        ),
        .plugin(
