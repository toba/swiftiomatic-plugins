...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "SmBinary",
            url: "https://github.com/toba/swiftiomatic/releases/download/v1.3.0/sm.artifactbundle.zip",
            checksum: "35cd63f1dfe9742b9fa963afc2f08e8fc5ab2ddacc46a668156555bf89223406"
        ),
        .plugin(
