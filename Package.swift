...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "SmBinary",
            url: "https://github.com/toba/swiftiomatic/releases/download/v3.5.5/sm.artifactbundle.zip",
            checksum: "7a04e12cf90420ec26a683f3933d281bcd665c74b5ee8711f5b5f7983d51b3f7"
        ),
        .plugin(
