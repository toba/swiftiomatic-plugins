...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "SmBinary",
            url: "https://github.com/toba/swiftiomatic/releases/download/v3.1.5/sm.artifactbundle.zip",
            checksum: "b29230fca8a391a4b1f3923496d9de85720798b9c6382edb72fe80f8f76843fd"
        ),
        .plugin(
