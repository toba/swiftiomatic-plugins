...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "SmBinary",
            url: "https://github.com/toba/swiftiomatic/releases/download/3.17.1/sm.artifactbundle.zip",
            checksum: "5e130cf32e4fbef501dbbc378f7ce87d313564fb3f294a20405f87c6bb7bd974"
        ),
        .plugin(
