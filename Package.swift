...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "SmBinary",
            url: "https://github.com/toba/swiftiomatic/releases/download/4.1.1/sm.artifactbundle.zip",
            checksum: "8f9afba84fa39637e3b3b5aecbeff1839a013a1bd8d93173ce535000409251a9"
        ),
        .plugin(
