...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "SmBinary",
            url: "https://github.com/toba/swiftiomatic/releases/download/v3.5.4/sm.artifactbundle.zip",
            checksum: "87d2545d4f2d25d9a2504ed5adbea3bc5adbd4001b417f440d546ff447efa3e5"
        ),
        .plugin(
