...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "SmBinary",
            url: "https://github.com/toba/swiftiomatic/releases/download/4.2.1/sm.artifactbundle.zip",
            checksum: "501a848b610e27e0b74378b71dd5dcff61c119fb3725acd410984477ff0487ff"
        ),
        .plugin(
