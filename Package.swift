...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "SmBinary",
            url: "https://github.com/toba/swiftiomatic/releases/download/v3.9.5/sm.artifactbundle.zip",
            checksum: "da47a6c4d029a501cae89e6821f8939dee350da70500b1f83f2cbc702dd8e0f4"
        ),
        .plugin(
