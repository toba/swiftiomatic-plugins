...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "SmBinary",
            url: "https://github.com/toba/swiftiomatic/releases/download/v1.5.0/sm.artifactbundle.zip",
            checksum: "d53cce9806fcc5e85b236dc26226b6ea541b8f89f721876d53f905fc20c1a328"
        ),
        .plugin(
