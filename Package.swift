...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "SmBinary",
            url: "https://github.com/toba/swiftiomatic/releases/download/v1.0.2/sm.artifactbundle.zip",
            checksum: "f6763b65af79d50622e8e30bf98bdac1ee0cd50ff5b34124bcb8caf3a14837c4"
        ),
        .plugin(
