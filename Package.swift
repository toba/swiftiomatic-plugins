...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "SmBinary",
            url: "https://github.com/toba/swiftiomatic/releases/download/v3.1.0/sm.artifactbundle.zip",
            checksum: "088deedcd857739af7a3e5d43d26138041d07a3463494218b7b4756fb2bda935"
        ),
        .plugin(
