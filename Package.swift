...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "SmBinary",
            url: "https://github.com/toba/swiftiomatic/releases/download/v1.2.9/sm.artifactbundle.zip",
            checksum: "a8c372c24f92b147c8a2114c97653d0549082ed1e8ba2dd75c30396a0caf49de"
        ),
        .plugin(
